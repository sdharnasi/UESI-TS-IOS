...
function EditAddressComponent(props) {
    const [formData, setData] = React.useState({ name: props.editData.name, country: parseInt(props.editData.country_id), city: props.editData.city, address1: props.editData.address_1, address2: props.editData.address_2, postcode: props.editData.postcode, submited: false });
